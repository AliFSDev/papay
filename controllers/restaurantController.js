...
restaurantController.getRestaurants = async (req, res) => {
    try {
        ...
        console.log(
            `ERROR: getRestaurantsga kirishda xatolik bor, ${err.message}`
        );
...
restaurantController.getChosenRestaurant = async (req, res) => {
    try {
        ...
        console.log(
            `ERROR: restaurantni o'zgartirishda xatolik bor, ${err.message}`
        );
...
restaurantController.home = (req, res) => {
    try {
        ...
        console.log(
            `ERROR: home pagega kirishda xatolik boldi! ${err.message}`
        );
        res.json({ state: "muvaffaqiyatsiz!", message: err.message });
    }
};
...
restaurantController.getMyRestaurantProducts = async (req, res) => {
    try {
        ...
        console.log(
            `ERROR: restaurant-menuga kirishda xatolik boldi! ${err.message}`
        );
        res.redirect("/resto");
    }
};
...
restaurantController.getSingupMyRestaurant = async (req, res) => {
    try {
        ...
        console.log(
            `ERROR: signup pagega kirishda xatolik boldi! ${err.message}`
        );
        res.json({ state: "muvaffaqiyatsiz!", message: err.message });
    }
};
...
restaurantController.getLoginMyRestaurant = async (req, res) => {
    try {
        ...
        console.log(
            `ERROR: login pagega kirishda xatolik boldi! ${err.message}`
        );
        res.json({ state: "muvaffaqiyatsiz!", message: err.message });
    }
};
